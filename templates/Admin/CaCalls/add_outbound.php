...
?>
	...
	<table class="table table-striped table-bordered">
		<tr><th class="col-md-3 tar">Call ID</th>
			<td class="col-md-9">
				<?php echo $id; ?>
			</td>
		</tr>
		...
		<tr><th class="tar">Call Type</th>
			<td class="col-md-9">
				<span class="callType"><?php echo empty($callType) ? '' : CaCall::$callTypes[$callType]; ?></span>
			</td>
		</tr>
				...
				<table class="table table-bordered table-condensed">
					...
					<?php foreach ($previousCalls as $call): ?>
						<tr>
							...
							<td><?php echo dateTimeEastern($call->start_time); ?></td>
							<td><?php echo gmdate("H:i:s", $call->duration); ?></td>
							<td><?php echo $this->App->getUserName($call->user_id); ?></td>
							<td>
								<?php
	...
	<div class="form_fields">
		<?php if ($isVoicemailCallback): ?>
			<div class="row">
				<div class="col-md-offset-3 col-md-9">
					Voicemail from <strong><?php echo formatPhoneNumber($caCallGroup->caller_phone); ?></strong> at <strong><?php echo $this->Clinic->getClinicDateTime($caCallGroup->location_id, $voicemailTime); ?></strong><br>
				...
				<div class="col-md-9 pt10">
					<div class="player">
						...
						if ($recordingUrl != 'Expired' && $recordingUrl != 'N/A') {
							echo $this->element('play_media', array('media' => array(
								'url' => $recordingUrl,
								'id' => $id,
		...
		<?php if (in_array($callType, [CaCall::CALL_TYPE_FOLLOWUP_APPT, CaCall::CALL_TYPE_FOLLOWUP_APPT_REQUEST])): ?>
			...
			<div class="row">
				<div class="col-md-offset-3 col-md-9">
					<div class="well blue-well">
						<i class="text-muted">
							Appointment requested by <strong><?php echo $callerName; ?></strong>
							<?php if (!$isPatient): ?>
								on behalf of <strong><?php echo $patientName; ?></strong>
							<?php endif; ?>
							<br>
							Caller phone: <?php echo formatPhoneNumber($caCallGroup->caller_phone); ?><br>
			...
			<div class="didTheyAnswerFollowupYes" style="display:none;">
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<div class="well blue-well">
							Hello, this is <?php echo $user['first_name']; ?> from Healthy Hearing. This call is being recorded for quality assurance. I'm calling because we received a
				...
				<?php echo $this->Form->control('ca_call_group.front_desk_name', array('autocomplete' => 'off')); ?>
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<div class="well blue-well">
							...
							<?php else: ?>
								Their number is
							<?php endif; ?>
							<strong><span class="callerPhone"><?php echo formatPhoneNumber($caCallGroup->caller_phone); ?></span></strong> and their main reason for calling is <strong><span class="callerTopics"></span></strong>.<br>
							...
							<i class="text-muted bold-number">[Call consumer: <span class="callerPhone"><?php echo formatPhoneNumber($caCallGroup->caller_phone); ?></span>]</i><br>
							Hi. May I speak with <strong><span class="callerFirstName"></span></strong>?<br>
							<i class="text-muted">[wait for consumer]</i><br>
						</div>
					</div>
				</div>
				<?php echo $this->Form->control('ca_call_group.didConsumerAnswer', [
					...
					<div class="row">
						<div class="col-md-offset-3 col-md-9">
							<div class="well blue-well">
								...
								Hi <strong><span class="callerFirstName"></span></strong>. This is <?php echo $user['first_name']; ?> from Healthy Hearing. This call is being recorded for quality assurance.
								<?php if ($isFollowupApptRequest): ?>
				...
				<div class="didConsumerAnswerNo" style="display:none;">
					<div class="row">
						<div class="col-md-offset-3 col-md-9">
							<div class="well blue-well mb0">
								...
								Hi <strong><span class="callerFirstName"></span></strong>. This is <?php echo $user['first_name']; ?> from Healthy Hearing.
								<?php if ($isFollowupApptRequest): ?>
									You filled out an appointment request form
								<?php else: ?>
									You called
								<?php endif; ?>
								for an appointment with <strong><span class="locationTitle"></span></strong>. I tried calling you today, <?php echo date('F d'); ?>, to connect you with them to set an appointment. Please call them back at <strong><span class="locationPhone"></span></strong>. Thank you.<br><br>
					...
					<?php echo $this->Form->control('ca_call_group.didClinicRefuse', array(
						'type' => 'checkbox',
				...
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<div class="well blue-well">
							...
							<?php if ($isProspect): ?>
								This is <?php echo $user['first_name']; ?> with Healthy Hearing. We tried to reach you today, <?php echo date('F d'); ?> at <span class="locationCurrentTime"></span> because we had a consumer trying to reach you to set an appointment.
								...
								<i class="text-muted">[Score as 'Tentative appointment'.]</i>
							<?php else: ?>
								This is <?php echo $user['first_name']; ?> from Healthy Hearing. We got a request for an appointment from <strong><span class="callerFirstName"></span></strong> <strong><span class="callerLastName"></span></strong>. They wanted an appointment for <strong><span class="callerTopics"></span></strong>. Please call them back directly at <strong><span class="callerPhone"></span></strong>. Thank you.
							<?php endif; ?>
						</div>
					</div>
				</div>
			...
			<div class="followupForm" style="display:none;">
				<?php echo $this->element('ca_calls/outbound_followup_script'); ?>
			</div>
			<div class="scheduled_call_date" style="display:none;">
				<?php echo $this->Form->control('ca_call_group.scheduled_call_date', [
			...
			echo $this->Form->control('ca_call_group.is_review_needed', array(
				'label' => [
					'class' => 'control-label',
		...
		<?php if ($callType == CaCall::CALL_TYPE_FOLLOWUP_APPT_REQUEST_DIRECT): ?>
			<div class="row">
				<div class="col-md-offset-3 col-md-9">
					<div class="well green-well">
						...
						Name: <strong><?php echo $callerName; ?></strong><br>
						<?php if (!$isPatient): ?>
						...
						Email: <strong><?php echo $caCallGroup->email; ?></strong><br>
						<br>
			...
			<div class="didConsumerAnswerYes" style="display:none;">
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<div class="well green-well">
							Hi <strong><span class="callerFirstName"></span></strong>. This is <?php echo $user['first_name']; ?> from Healthy Hearing. This call is being recorded for quality assurance. You filled out an appointment request form for an appointment with <strong><span class="locationTitle"></span></strong>. I would be happy to help you set that appointment.<br><br>
					...
					<div class="row">
						...
						<div class="didTheyAnswerFollowupYes" style="display:none;">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<div class="well blue-well">
										Hello, this is <?php echo $user['first_name']; ?> from Healthy Hearing. This call is being recorded for quality assurance. I'm calling because I have a prospective patient who is trying to reach your clinic to make an appointment. First, can I get your name?
									</div>
								</div>
							</div>
							<?php echo $this->Form->control('ca_call_group.front_desk_name', array('autocomplete' => 'off')); ?>
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<div class="well blue-well">
										...
										Their number is <strong><span class="callerPhone"><?php echo formatPhoneNumber($caCallGroup->caller_phone); ?></span></strong> and their main reason for calling is <strong><span class="callerTopics"></span></strong>.<br>
						...
						<div class="didTheyAnswerFollowupVm" style="display:none;">
							<div class="row">
								<div class="col-md-offset-3 col-md-9">
									<div class="well blue-well">
										<i class="text-muted">[Leave a voicemail]</i><br />
										This is <?php echo $user['first_name']; ?>  with Healthy Hearing. We tried to reach you today, <?php echo date('F d'); ?> at <span class="locationCurrentTime"></span> because we had a consumer trying to reach you to set an appointment for a hearing test.
										Their name is <strong><span class="callerFirstName"></span></strong> <strong><span class="callerLastName"></span></strong>. That spelling is <i class="text-muted">[spell caller first name, caller last name]</i>.
			...
			<div class="didConsumerAnswerNo" style="display:none;">
				...
				<div class="didTheyAnswerFollowupYes" style="display:none;">
					...
					<?php echo $this->Form->control('ca_call_group.didConsumerAnswer2', [
		...
		<?php if ($callType == CaCall::CALL_TYPE_FOLLOWUP_TENTATIVE_APPT): ?>
			...
			<?php echo $this->Form->control('ca_call_group.did_they_answer_followup', [
				'options' => ['yes'=>'Yes', 'no'=>'No'],
				'empty' => 'Select One',
				'label' => 'Did clinic answer?',
				'required' => true
		...
		<?php if ($callType == CaCall::CALL_TYPE_FOLLOWUP_NO_ANSWER): ?>
			...
			<div class="row">
				<div class="col-md-offset-3 col-md-9">
					<div class="well blue-well">
						<i class="text-muted bold-number">[Call patient: <?php echo formatPhoneNumber($caCallGroup->caller_phone); ?>]</i><br>
					</div>
				</div>
			</div>
			<?php echo $this->Form->control('ca_call_group.did_they_answer_followup', array(
				'options' => array('yes'=>'Yes', 'no'=>'No', 'vm'=>'No, but leave voicemail'),
				'empty' => 'Select One',
			...
			<div class="didTheyAnswerFollowupYes" style="display:none;">
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<div class="well blue-well">
							...
							Hello, this is <?php echo $user['first_name']; ?> with Healthy Hearing on behalf of <strong><span class="locationTitle"></span></strong>. This call may be recorded. You contacted us on <strong><?php echo date('M d', strtotime($caCallGroup->created)); ?></strong> about making an appointment<?php echo $isPatient ? '' : '<strong> for '.$patientName.'</strong>'; ?>. Unfortunately, we were unable to speak with anyone at <strong><span class="locationTitle"></span></strong> to set that appointment. Were you able to connect with that clinic?
						</div>
					</div>
				</div>
				<?php echo $this->Form->control('ca_call_group.didClinicContactConsumer', [
					'options' => ['1'=>'Yes', '0'=>'No'],
					'empty' => 'Select One',
				...
				<div class="didClinicContactConsumerNo" style="display:none;">
					...
					<?php echo $this->Form->control('ca_call_group.did_they_want_help', [
						'options' => ['1'=>'Yes', '0'=>'No'],
						'empty' => 'Select One',
				...
				<div class="row">
					<div class="col-md-offset-3 col-md-9">
						<div class="well blue-well">
							...
							Hello, I'm calling for <strong><?php echo $callerName; ?></strong>.<br>
							This is <?php echo $user['first_name']; ?> with Healthy Hearing on behalf of <strong><span class="locationTitle"></span></strong>. You contacted us on <strong><?php echo date('M d', strtotime($caCallGroup->created)); ?></strong> about making an appointment<?php echo $isPatient ? '' : '<strong> for '.$patientName.'</strong>'; ?>. Unfortunately, we were unable to get ahold of anyone at <strong><span class="locationTitle"></span></strong> to set that appointment.<br>
...
<script type="text/javascript">
	...
	var isCallDateSet = <?php echo json_encode(isset($caCallGroup->scheduled_call_date)); ?>,
