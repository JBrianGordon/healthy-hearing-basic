...
<div class="row">
	<div class="col-md-offset-3 col-md-9">
		<div class="well blue-well">
			<i class="text-muted">[Call consumer at <?= formatPhoneNumber($voicemailFrom) ?> (or number left in message)]</i>
		</div>
	</div>
</div>
<?= $this->Form->control('ca_call_group.did_they_answer_vm', [
	'options' => [
		'yes' => 'Yes',
		'no' => 'No',
...
<div id="didTheyAnswerYes" style="display:none;">
	<div class="row">
		<div class="col-md-offset-3 col-md-9">
			<div class="well blue-well">
				Hello, this is <?= $user['first_name'] ?> returning your call to Healthy Hearing. You left us a voicemail <?= $this->CaCallGroup->formatDate(strtotime($voicemailTime)) ?>. This call is being recorded for quality assurance. Can you tell me the name of the clinic you're trying to reach so I can get you connected?<br>
	...
	<?= $this->element('ca_calls/inbound_call_script', ['showScript'=>true]) ?>
</div>
<div id="didTheyAnswerNo">
	...
	<?= $this->Form->control("ca_call_group.ca_call_group_notes.$noteCount.body", [
		'label' => [
			'class' => 'col col-md-3 control-label',
			'text' => 'Add a note'],
		'rows' => 3,
