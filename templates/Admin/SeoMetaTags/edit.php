...
<header class="col-md-12 mt10">
    <div class="panel panel-light">
        <div class="panel-heading">Meta Tags Actions</div>
        <div class="panel-body p10">
            <div class="btn-group">
                ...
                <?= $this->Html->link(' Delete', ['action' => 'delete', $seoMetaTag->id], ['confirm' => __('Are you sure you want to delete # {0}?', $seoMetaTag->id), 'class' => 'btn btn-danger bi-trash-fill', 'id' => 'deleteBtn']) ?>
