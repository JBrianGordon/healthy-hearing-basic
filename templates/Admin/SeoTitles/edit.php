    ...
    <div class="panel panel-light">
        ...
        <div class="panel-body p10">
            <div class="btn-group">
                ...
                <?= $this->Html->link(' Delete', ['action' => 'delete', $seoTitle->id], ['confirm' => __('Are you sure you want to delete # {0}?', $seoTitle->id), 'class' => 'btn btn-danger bi-trash-fill', 'id' => 'deleteBtn']) ?>
