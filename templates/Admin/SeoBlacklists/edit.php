    ...
    <div class="panel panel-light">
        ...
        <div class="panel-body p10">
            <div class="btn-group">
                ...
                <?= $this->Html->link(' Delete', ['action' => 'delete', $seoBlacklist->id], ['confirm' => __('Are you sure you want to delete # {0}?', $seoBlacklist->id), 'class' => 'btn btn-danger bi-trash-fill', 'id' => 'deleteBtn']) ?>
                    ...
                    <div class="column-responsive column-80">
                        <div class="seoBlacklists form content">
                            ...
                            <div class="form-actions tar">
                                <?= $this->Form->button('Save Blacklist', ['class' => 'btn btn-primary btn-lg']) ?>
