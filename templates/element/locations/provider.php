	...
	<?php
		if (isset($provider)) {
				if (!empty($provider->photo_name) && !empty($provider->photo_url)) {
					...
					echo "<div class='form-group'><div class='col-md-9 col-md-offset-3'><div class='profile-pic-container'><img id=provider-pic-" . $key . " class='img-responsive' src=". $provider->photo_url . " loading='lazy' style='max-width:150px'</div></div></div></div>";
				}
