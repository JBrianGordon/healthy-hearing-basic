...
$clinic_name = isset($clinic_name) ? $clinic_name : $review->location->title;
...
<div class="<?= $reviewClass ?>" itemscope itemtype="https://schema.org/Review">
	...
	<div itemprop="author" class="author">
		...
		<?php echo $this->Clinic->reviewVerification($review); ?>
	</div>
	<?php if ($show_response) : ?>
		<div class="response">
			...
			<div class="who">- <strong>Official Response<?php if($clinic_name) { echo " from $clinic_name";} ?></strong></div>
		</div>
	<?php endif; ?>
</div>
