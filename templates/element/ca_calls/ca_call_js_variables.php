...
<script type="text/javascript">
	...
	window.CALL_TYPE_OUTBOUND_CLINIC = <?php echo json_encode(CaCall::CALL_TYPE_OUTBOUND_CLINIC); ?>;
	window.CALL_TYPE_OUTBOUND_CALLER = <?php echo json_encode(CaCall::CALL_TYPE_OUTBOUND_CALLER); ?>;
	window.CALL_TYPE_SURVEY_DIRECT = <?php echo json_encode(CaCall::CALL_TYPE_SURVEY_DIRECT); ?>;
	...
	window.STATUS_OUTBOUND_CLINIC_ATTEMPTED = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CLINIC_ATTEMPTED); ?>;
	window.STATUS_OUTBOUND_CLINIC_COMPLETE = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CLINIC_COMPLETE); ?>;
	window.STATUS_OUTBOUND_CLINIC_TOO_MANY_ATTEMPTS = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CLINIC_TOO_MANY_ATTEMPTS); ?>;
	window.STATUS_OUTBOUND_CLINIC_DECLINED = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CLINIC_DECLINED); ?>;
	window.STATUS_OUTBOUND_CUST_ATTEMPTED = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CUST_ATTEMPTED); ?>;
	window.STATUS_OUTBOUND_CUST_SURVEY_COMPLETE = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CUST_SURVEY_COMPLETE); ?>;
	window.STATUS_OUTBOUND_CUST_TOO_MANY_ATTEMPTS = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CUST_TOO_MANY_ATTEMPTS); ?>;
	window.STATUS_OUTBOUND_CUST_DECLINED = <?php echo json_encode(CaCallGroup::STATUS_OUTBOUND_CUST_DECLINED); ?>;
	...
	window.MAX_CLINIC_OUTBOUND_ATTEMPTS = <?php echo json_encode(CaCallGroup::MAX_CLINIC_OUTBOUND_ATTEMPTS); ?>;
	window.MAX_PATIENT_OUTBOUND_ATTEMPTS = <?php echo json_encode(CaCallGroup::MAX_PATIENT_OUTBOUND_ATTEMPTS); ?>;
