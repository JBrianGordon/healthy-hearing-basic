<footer class="row site-footer noprint">
	<div class="container">
		<div class="row footer-row">
			<div class="col-md-2">
				<ul class="no-bullets">
					...
					<?php //***TODO: uncomment when Configure is built*** if (Configure::read('showFeeds')): ?>
			...
			<div class="col-md-2">
				<ul class="no-bullets">
					<?php //***TODO: uncomment when Configure is built*** if (Configure::read('showReports')): ?>
						<li><a href="/report" class="text-link">The <?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteNameAbbr'); ?>HH report</a></li>
					<?php //endif; ?>
					<?php //***TODO: uncomment when Configure is built*** if (Configure::read('showHearingTest')): ?>
			...
			<div class="col-md-2">
				<ul class="no-bullets">
					...
					<?php //***TODO: uncomment when Configure is built*** if (Configure::read('showManufacturers')): ?>
			...
			<div class="col-md-6">
				<?php //***TODO: uncomment when Configure is built*** if (Configure::read('showNewsletter')): ?>
				...
				<?php //endif; ?>
				<div class="soc-icons">
					<?php //***TODO: uncomment when Configure is built*** if(Configure::read('sameAsSocialLinks.facebook')): ?>
						<a href="<?php //***TODO: uncomment when Configure is built*** echo Configure::read('sameAsSocialLinks.facebook') ?>" class="text-light" target="_blank" rel="noopener"><span class="hh-icon-circle-facebook"></span><?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteNameAbbr') ?> Facebook page</a>
					<?php //endif; ?>
					<?php //***TODO: uncomment when Configure is built*** if(Configure::read('sameAsSocialLinks.twitter')): ?>
						<a href="<?php //***TODO: uncomment when Configure is built*** echo Configure::read('sameAsSocialLinks.twitter') ?>" class="text-light" target="_blank" rel="noopener"><?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteNameAbbr') ?> Twitter page<span class="hh-icon-circle-twitter"></span></a>
					<?php //endif; ?>
					<?php //***TODO: uncomment when Configure is built*** if(Configure::read('sameAsSocialLinks.youtube')): ?>
						<a href="<?php //***TODO: uncomment when Configure is built*** echo Configure::read('sameAsSocialLinks.youtube') ?>" class="text-light" target="_blank" rel="noopener"><span class="hh-icon-circle-youtube"></span><?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteNameAbbr') ?> YouTube page</a>
					<?php //endif; ?>
				</div>

				<?php //***TODO: uncomment when Configure is built*** if(Configure::read('isCallAssistEnabled')): ?>
		...
		<div class="row">
			<!-- In Partnership With -->
			<div class="<?php //***TODO: uncomment when settings var is set*** if ($settings['country'] == 'CA') {echo 'ca-';} ?>partner-block col-md-6">
				<p class="text-primary text-small">
					<em>In partnership <br class="hidden-xs hidden-sm">with</em>            
					<?php //***TODO: uncomment when settings var is set*** if ($settings['country'] == 'US'): ?>
					...
					<?php //***TODO: uncomment when settings var is set*** elseif ($settings['country'] == 'CA'): ?>
...
<footer class="row site-colophon noprint">
	<div class="col-md-12 text-center text-small">
		...
		<?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteUrl'); ?>HealthyHearing.com does not provide medical advice, diagnosis or treatment.
	</div>
</footer>
...
<?php if (!empty($show_organization_schema)): ?>
	<!--***TODO: uncomment when Configure is built*** 
	<script type="application/ld+json">
	{
		"@context" : "https://schema.org",
		"@type" : "Organization",
		"name" : "<?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteName'); ?>",
		"url" : "https://www.<?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteUrl'); ?>",
		"logo": "https://www.<?php //***TODO: uncomment when Configure is built*** echo Configure::read('siteUrl') . Configure::read('logo'); ?>"
		<?php //***TODO: uncomment when Configure is built*** if (Configure::read('country') == 'US'): ?>
		,
		"sameAs" : [
