								...
								<div class="panel-section expanded basic-info">
									<div class="row">
										<div class="<?= Configure::read('country') != 'CA' ? 'col-12' : 'col-md-6'; ?> clinic-info">
											...
											<?php endif; ?>
											<div class="clinicPhone<?= $isMobileDevice ? " btn btn-success d-block" : "" ?>" data-id="<?= $location->id ?>">
								...
								<div id="apptRequestModal">
									<div class="modal-content">
										<?= $this->Form->create(null, [
											...
											<button type="button" class="close pt10" data-bs-dismiss="modal">X</button>
							...
							<?php
								...
								if ($isEnhancedOrPremier) {
									$badgeArray = [
										...
										['isOn' => $location->badge_oticon_foundation, 'badgeElement' => '<img loading="lazy" class="badge-img" alt="Oticon Hearing Foundation donor" width="28" height="28" src="/img/heart.png"><p class="icon-text">Oticon Hearing Foundation donor</p>'],
										['isOn' => $location->badge_hearing_simulator, 'badgeElement' => '<img loading="lazy" class="badge-img" alt="Hearing loss simulator" width="28" height="28" src="/img/headphones.png"><p class="icon-text">Hearing loss simulator</p>'],
