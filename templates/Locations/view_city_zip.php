				...
				<section class="panel">
					<div class="panel-body">
						<div class="panel-section expanded">
							<header class="row">
								<div class="col-md-12">
									<h1 class="text-primary" style="margin-bottom:0">Hearing <?= Configure::read('regionalSpelling.center')?>s <?= (!empty($is_near)) ? 'near' : 'in' ?> <?= $this->Clinic->nearText($region,$city,$zip) ?></h1>
								</div>
							</header>
							<p class="lead text-primary mb0" id="filter-results">
								<?php if($state == "Quebec") : ?>
								...
								<?php else: ?>
									<!-- Commented out in case we do ever decide to bring this information back. -->
									<!--<i>
										<?php /*
									...
									<br>
									<p class="mb15"><?php /* echo $siteName */ ?> provides listings from audiologists, hearing instrument specialists and hearing aid <?php /* echo Configure::read('regionalSpelling.center') */ ?>s near you. If you need hearing aids or a hearing test, choose a clinic from the list below to schedule an appointment in your area.</p>-->
									<?php if ($isAdmin): ?>
										<?php
