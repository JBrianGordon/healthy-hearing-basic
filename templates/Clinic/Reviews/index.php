...
<div class="row card-row" style="display:none">
    <div class="review-card">
        <div class="review-border">
            ...
            <h4 class="text-center clinic-name"><?php echo $locationTitle; ?></h4>
            ...
            <p class="text-center clinic-url mb10"><?php echo $shortReviewUrl; ?></p>
...
<?php if ($isAdmin && !isset($locationId)): ?>
    <?php echo $this->Form->create($reviews); ?>
...
<?php //TODO: echo $this->Html->addJsDefer('/js/dist/review_clinic_index.min.js?v='.Configure::read("tagVersion")); ?>
