...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $schemaMigration->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $schemaMigration->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="schemaMigrations form content">
            ...
            <fieldset>
                <legend><?= __('Edit Schema Migration') ?></legend>
                <?php
