...
<p>Your answers reveal you probably have normal hearing. However, since you were concerned enough to take our test, you may still want to see a hearing care specialist. Use our <?= $this->Html->link('directory', Router::url($this->Clinic->nearMeLink(),true)) ?> to find one near you.</p>
