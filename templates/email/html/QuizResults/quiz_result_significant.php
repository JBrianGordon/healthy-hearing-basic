...
<p>Untreated hearing loss is linked to many negative health impacts, including <?= $this->Html->link('cognitive decline', Router::url('/report/52904-The-connection-between-hearing-loss-and-cognitive-decline', true)) ?>. The good news? <?= $this->Html->link('Hearing aids', Router::url('/help/hearing-aids', true)) ?> can delay the onset of dementia and provide many other <?= $this->Html->link('health benefits', Router::url('/help/hearing-aids/health-benefits', true)) ?>.</p>
