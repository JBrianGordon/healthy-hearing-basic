...
<p>Your answers reveal you likely have normal hearing. However, a hearing screening is the first step to better overall health. You may still want to speak with a hearing care provider who can provide you with a thorough assessment of your hearing. Use our nation-wide <?= $this->Html->link('directory', $this->Html->url($this->Clinic->nearMeLink(),true)) ?> to find a hearing clinic near you.</p>

<p>Did you know you can help <?= $this->Html->link('prevent hearing loss', $this->Html->url('/help/hearing-loss/prevention', true)) ?>? A healthy lifestyle and reducing your noise exposure can go a long way.</p>
