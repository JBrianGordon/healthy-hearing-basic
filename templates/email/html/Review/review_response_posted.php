...
Reviews are an effective way to build your clinic’s online reputation and help this profile stand out amongst the competition; <?= Configure::read('sieName') ?> profiles with reviews get three times more calls and appointments than those without reviews. Don’t be shy about suggesting to all of your patients that they review your practice.<br /><br />
