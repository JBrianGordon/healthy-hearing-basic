...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $importLocation->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $importLocation->id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column-responsive column-80">
        <div class="importLocations form content">
            ...
            <fieldset>
                <legend><?= __('Edit Import Location') ?></legend>
                <?php
