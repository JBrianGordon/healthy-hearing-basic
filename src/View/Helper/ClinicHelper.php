    ...
    */
    ...
    public function getBadges($location) {
        ...
        $badgeArray = [
            ...
            ['isOn' => $location->badge_oticon_foundation, 'fontIcon' => '<a class="amenity-popover" data-toggle="popover" data-bs-trigger="hover click" data-bs-content="Oticon Hearing Foundation donor" data-html="true" data-bs-placement="top" href=""><img loading="lazy" class="badge-img" alt="Oticon Hearing Foundation donor" width="28" height="28" src="/img/heart.png"></a>'],
            ['isOn' => $location->badge_hearing_simulator, 'fontIcon' => '<a class="amenity-popover" data-toggle="popover" data-bs-trigger="hover click" data-bs-content="Hearing loss simulator" data-html="true" data-bs-placement="top" href=""><img loading="lazy" class="badge-img" alt="Hearing loss simulator" width="28" height="28" src="/img/headphones.png"></a>'],
